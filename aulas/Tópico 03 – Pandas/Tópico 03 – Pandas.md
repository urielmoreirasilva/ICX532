---
layout: default
title: "Tópico 03 – Pandas"
parent: "Aulas"
nav_order: 3
---
# Tópico 03 – Pandas [<img src="https://raw.githubusercontent.com/urielmoreirasilva/ICX532/main/aulas/T%C3%B3pico%2003%20%E2%80%93%20Pandas/images/colag_logo.svg" style="float: right; vertical-align: middle; width: 42px; height: 42px;">](https://colab.research.google.com/github/urielmoreirasilva/ICX532/blob/main/aulas/T%C3%B3pico%2003%20%E2%80%93%20Pandas/T%C3%B3pico%2003%20%E2%80%93%20Pandas.ipynb) [<img src="https://raw.githubusercontent.com/urielmoreirasilva/ICX532/main/aulas/T%C3%B3pico%2003%20%E2%80%93%20Pandas/images/github_logo.svg" style="float: right; margin-right: 12px; vertical-align: middle; width: 36px; height: 36px;">](https://github.com/urielmoreirasilva/ICX532/blob/main/aulas/T%C3%B3pico%2003%20%E2%80%93%20Pandas/T%C3%B3pico%2003%20%E2%80%93%20Pandas.ipynb)
...
<center>
    <img src="https://raw.githubusercontent.com/urielmoreirasilva/ICX532/main/aulas/T%C3%B3pico%2003%20%E2%80%93%20Pandas/images/pandas.png" width = 50%>
</center>

### DataFrames em `pandas` 🐼

- As "tabelas" em e `pandas` são chamadas de "DataFrames".
- Para usar DataFrames, precisaremos importar `pandas` (e `numpy` também).
...
<center>
    <img src="https://raw.githubusercontent.com/urielmoreirasilva/ICX532/main/aulas/T%C3%B3pico%2003%20%E2%80%93%20Pandas/images/afonsopena.webp" width = 35%>
</center>

### Lendo dados de um arquivo 📖

Podemos ler um CSV utilizando `pd.read_csv(...)`.

Assumindo que o arquivo esteja na mesma pasta do seu notebook, basta especificar um caminho relativo como argumento para a função `pd.read_csv`.


```python
pd.read_csv('https://raw.githubusercontent.com/urielmoreirasilva/ICX532/main/aulas/T%C3%B3pico%2003%20%E2%80%93%20Pandas/data/afonso_pena.csv')
```
...
```python
afonso_pena = pd.read_csv('https://raw.githubusercontent.com/urielmoreirasilva/ICX532/main/aulas/T%C3%B3pico%2003%20%E2%80%93%20Pandas/data/afonso_pena.csv')
```
...
- Podemos definir um índice alternativo para as linhas utilizando `.set_index(column_name)`.
- Para isso, como os rótulos das linhas se tornarão seus "nomes",  idealmente cada linha terá um nome descritivo e informativo o suficiente (e que logo também deverá ser _único_).
- ⚠️ Como a maioria dos métodos definidos para DataFrames, `.set_index` retorna um novo DataFrame, e logo _não modifica_ o DataFrame original.
...
## Problema #1. Operações aritméticas com uma coluna
...
- Podemos retornar uma coluna de um DataFrame usando `.get(column_name)`.
...
Ordenamos o DataFrame com sucesso, porém em ordem _crescente_ (isto é, do menor para o maior).
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th>1407</th>
      <td>J.F4.V032</td>
      <td>BARRACA CALMA MARIA DE LIMA OLIVEIRA LANCUNA</td>
      <td>CALMA MARIA DE LIMA OLIVEIRA LANCUNA</td>
      <td>MILTON ANTONIO INACIO</td>
      <td>Calçados</td>
      <td>RASTEIRINHA</td>
      <td>1.0</td>
      <td>11.827592</td>
    ...
    <tr>
      <th>217</th>
      <td>P.F1.V021</td>
      <td>BARRACA IDALINO BANDEIRA ROCHA</td>
      <td>IDALINO BANDEIRA ROCHA</td>
      <td>PALOMA FARIAS BANDEIRA</td>
      <td>Artes e Pintura</td>
      <td>PINTURA A ÓLEO</td>
      <td>1.0</td>
      <td>23.790191</td>
    ...
    <tr>
      <th>1413</th>
      <td>J.F4.V008</td>
      <td>BARRACA RICARDO AUGUSTO DE SOUZA LIMA</td>
      <td>RICARDO AUGUSTO DE SOUZA LIMA</td>
      <td>ELAINE TEREZINHA MOREIRA REIS</td>
      <td>Calçados</td>
      <td>SANDÁLIA</td>
      <td>1.0</td>
      <td>11.827592</td>
    ...
    <tr>
      <th>754</th>
      <td>C.F4.V011</td>
      <td>BARRACA CID MARCOS FRANCA MOREIRA</td>
      <td>CID MARCOS FRANCA MOREIRA</td>
      <td>SORAYA FATIMA CUNHA CAETANO</td>
...
## Problema #3. Operações aritméticas com múltiplas colunas
...
Escreva um código em cada célula de código abaixo para calcular:
1. A densidade máxima das barracas.
2. A densidade mínima das barracas.
3. A densidade média das barracas.
...
## Problema #4. Fazendo consultas em um DataFrame
...
Para atingir nosso objetivo original, podemos _transmitir_ a verificação de igualdade para cada elemento de uma `Series`, no caso nossa coluna `NOME_SETOR`.
...
```
    ...
    np.float64(12.378615690707454)



Parece que as barracas de comida têm bem mais espaço do que as que vendem produtos para crianças! 

Em retrospecto, isso é bem razoável, uma vez que os vendedores dessas barracas em geral precisam de espaço não só para armazenar seus produtos, mas tambeḿ para cozinhar!
